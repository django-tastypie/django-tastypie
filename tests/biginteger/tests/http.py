...
class HTTPTestCase(TestServerTestCase):
            ...
            'objects': [
                {
                    ...
                    'resource_uri': '/api/v1/products/9007199254740990/',
                    'name': 'Skateboardrampe',
                    'artnr': 9007199254740990,
                    'created': '2010-03-30T20:05:00'
                },
                {
                    'updated': '2010-05-04T20:05:00',
                    'resource_uri': '/api/v1/products/9007199254740991/',
                    'name': 'Bigwheel',
                    'artnr': 9007199254740991,
                    'created': '2010-05-04T20:05:00'
                },
                {
                    'updated': '2010-05-04T20:05:00',
                    'resource_uri': '/api/v1/products/9007199254740992/',
                    'name': 'Trampolin',
                    'artnr': 9007199254740992,
                    'created': '2010-05-04T20:05:00'
                },
                {
                    'updated': '2010-05-04T20:05:00',
                    'resource_uri': '/api/v1/products/9007199254740980/',
                    'name': 'Laufrad',
                    'artnr': 9007199254740980,
                    'created': '2010-05-04T20:05:00'
                },
                {
                    'updated': '2010-05-04T20:05:00',
                    'resource_uri': '/api/v1/products/9007199254740981/',
                    'name': 'Bigwheel',
                    'artnr': 9007199254740981,
                    'created': '2010-05-04T20:05:00'
                },
                {
                    'updated': '2010-05-04T20:05:00',
                    'resource_uri': '/api/v1/products/9007199254740982/',
                    'name': 'Trampolin',
                    'artnr': 9007199254740982,
                    'created': '2010-05-04T20:05:00'
                }
            ]
        }
    ...
    def test_post_object(self):
        connection = self.get_connection()
        post_data = '{"artnr": 534, "name": "Bigwheel XXL"}'
        ...
        self.assertEqual(dict(response.getheaders())['location'], 'http://localhost:8001/api/v1/products/534/')
    
        # make sure posted object exists
        connection.request('GET', '/api/v1/products/534/', headers={'Accept': 'application/json'})
        response = connection.getresponse()
        connection.close()
        ...
        self.assertEqual(obj['artnr'], 534)
