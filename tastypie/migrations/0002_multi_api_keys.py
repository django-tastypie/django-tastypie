...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('tastypie_apikey', ['user_id'])

        # Adding field 'ApiKey.description'
        db.add_column('tastypie_apikey', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


        # Changing field 'ApiKey.user'
        db.alter_column('tastypie_apikey', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'ApiKey.description'
        db.delete_column('tastypie_apikey', 'description')


        # Changing field 'ApiKey.user'
        db.alter_column('tastypie_apikey', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'ApiKey', fields ['user']
        db.create_unique('tastypie_apikey', ['user_id'])
    ...
    models = {
        ...
        'tastypie.apikey': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 0, 0)'}),
