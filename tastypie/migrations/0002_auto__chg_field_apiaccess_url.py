...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApiAccess.url'
        db.alter_column('tastypie_apiaccess', 'url', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'ApiAccess.url'
        db.alter_column('tastypie_apiaccess', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
